...
- Preserved mode is applied before the selected final file sync. Parent identity is checked around rename, and only the retained matching handle is synchronized afterward.
