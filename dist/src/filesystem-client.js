...
function ensureAnchorMatches(lines, anchorRaw) {
...
function applyReplaceText(text, oldText, newText) {
...
function applySimpleFallback(lines, edit) {
    const next = [...lines];
...
export class FilesystemPiClient {
    ...
    async edit({ path, edits }) {
        ...
        for (const edit of edits) {
            ...
            try {
                const result = applyHashlineEdits(normalized, resolveEditAnchors([edit]));
